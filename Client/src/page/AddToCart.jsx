                        ...
                        <div className="lg:col-span-2 bg-white p-4 rounded-2xl shadow">
                            ...
                            <div className="flex flex-col md:flex-row items-center gap-4 pb-4">
                                ...
                                <div className="flex-1 text-center md:text-left">
                                    ...
                                    <p className="text-green-600 font-semibold mt-1">₹999</p>
                                </div>

                                {/* Quantity */}
                                <div className="flex items-center gap-2">
                                    <button className="px-3 py-1 bg-gray-200 rounded-lg hover:bg-gray-500">-</button>
                                    <span className='text-base'>1</span>
                                    <button className="px-3 py-1 bg-gray-200 rounded-lg hover:bg-gray-500">+</button>
                                </div>

                                {/* Remove */}
                                <button className="text-white bg-red-500 p-1 rounded-md text-sm mt-2 md:mt-0">
                                    Remove
                                </button>
                            </div>
