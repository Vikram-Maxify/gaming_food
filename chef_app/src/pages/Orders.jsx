...
//   useEffect(() => {
//     if (orders.length > prevLength.current) {
...
//     prevLength.current = orders.length;
//   }, [orders]);
  ...
  return (
    <div className="p-6 min-h-screen bg-[#0f0f0f] text-white">
      ...
      <div className="sticky top-0 z-10 bg-[#0f0f0f]/80 backdrop-blur py-4 mb-6 border-b border-gray-800">
        ...
        <p className="text-sm text-gray-400">Real-time kitchen dashboard</p>
      </div>
                ...
                {order.items?.map((item, idx) => (
                  <div key={idx} className="border-b border-gray-800 pb-2">
                    ...
                    <div className="flex justify-between text-xs text-gray-400">
                      <span>{item.spiceLevel || "normal"}</span>
                      <span>
