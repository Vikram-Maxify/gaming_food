...
import { Plus, Star, Flame, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="mb-8">
      ...
      <div className="flex items-center justify-between px-4 mb-5">
        ...
        <Link
          to="/menu"
          className="group flex items-center gap-1 text-sm font-medium text-orange-500 hover:text-orange-600 transition-all duration-300"
        >
          <span>Add on</span>
        ...
        {riceItems.map((item, i) => {
          return (
            ...
            >
              ...
              {/* Content */}
              <div className="p-3">
                <h4 className="text-sm font-bold leading-tight line-clamp-1 text-gray-800 group-hover:text-orange-500 transition-colors duration-300">
                  {item.name}
                </h4>
